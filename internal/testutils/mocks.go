...
func (m MockResource) GetUIMeta() *resources.UIMetadata { return m.config.GetUIMeta() }
...
func (m MockResourceTemplate) GetUIMeta() *resources.UIMetadata { return m.config.GetUIMeta() }
