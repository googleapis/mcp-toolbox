...
package getadvancedaggregatedquerystats_test
...
import (
	...
	getstats "github.com/googleapis/mcp-toolbox/internal/tools/databaseinsights/getadvancedaggregatedquerystats"
...
func TestParseFromYaml(t *testing.T) {
	...
	tcs := []struct {
	...
	}{
		{
            ...
            description: fetches execution statistics
            `,
			want: server.ToolConfigs{
				"get_aggregated_stats": getstats.Config{
...
type mockSource struct {
	sources.Source
	t           *testing.T
	expectedReq *databaseinsights.FetchQueryStatsRequest
	resp        *databaseinsights.FetchQueryStatsResponse
	err         error
}

func (m *mockSource) FetchQueryStats(ctx context.Context, req *databaseinsights.FetchQueryStatsRequest) (*databaseinsights.FetchQueryStatsResponse, error) {
...
func TestInvoke(t *testing.T) {
	...
	if diff := cmp.Diff(mockSrc.resp, got, cmpopts.IgnoreUnexported(databaseinsights.FetchQueryStatsResponse{})); diff != "" {
