...
package lookercreateconversation
...
const resourceType string = "looker-create-conversation"
...
func (cfg Config) Initialize(ctx context.Context) (tools.Tool, error) {
	...
	nameParameter := parameters.NewStringParameter("name", "The name of the conversation.", parameters.WithStringDefault(""))
	...
	params := parameters.Parameters{nameParameter, agentIdParameter, categoryParameter, sourcesParameter}
...
func (t Tool) Invoke(ctx context.Context, s sources.Source, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	var name, agentID, category string
	...
	resp, err := sdk.CreateConversation(body, "", source.LookerApiSettings())
	if err != nil {
