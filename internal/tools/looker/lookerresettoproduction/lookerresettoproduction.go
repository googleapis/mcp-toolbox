...
package lookerresettoproduction
...
const resourceType string = "looker-reset-to-production"
...
func (t Tool) Invoke(ctx context.Context, s sources.Source, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	resp, err := sdk.ResetProjectToProduction(projectId, source.LookerApiSettings())
	if err != nil {
