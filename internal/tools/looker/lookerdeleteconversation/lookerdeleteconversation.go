...
package lookerdeleteconversation
...
const resourceType string = "looker-delete-conversation"
...
func (t Tool) Invoke(ctx context.Context, s sources.Source, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	resp, err := sdk.DeleteConversation(conversationId, "", source.LookerApiSettings())
	if err != nil {
