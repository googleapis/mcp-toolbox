...
package lookerdeleteconversationmessage
...
const resourceType string = "looker-delete-conversation-message"
...
func (cfg Config) Initialize(ctx context.Context) (tools.Tool, error) {
	...
	messageIdParameter := parameters.NewStringParameter("message_id", "The ID of the message to delete.", parameters.WithStringDefault(""))
	params := parameters.Parameters{conversationIdParameter, messageIdParameter}
...
func (t Tool) Invoke(ctx context.Context, s sources.Source, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	resp, err := sdk.DeleteConversationMessage(conversationId, messageId, "", source.LookerApiSettings())
	if err != nil {
