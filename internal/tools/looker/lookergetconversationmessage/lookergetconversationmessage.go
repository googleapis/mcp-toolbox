...
package lookergetconversationmessage
...
const resourceType string = "looker-get-conversation-message"
...
func (cfg Config) Initialize(ctx context.Context) (tools.Tool, error) {
	...
	messageIdParameter := parameters.NewStringParameter("message_id", "The ID of the message.", parameters.WithStringDefault(""))
...
func (t Tool) Invoke(ctx context.Context, s sources.Source, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	resp, err := sdk.GetConversationMessage(conversationId, messageId, "", source.LookerApiSettings())
	if err != nil {
