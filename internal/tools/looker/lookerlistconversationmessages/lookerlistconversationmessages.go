...
package lookerlistconversationmessages
...
const resourceType string = "looker-list-conversation-messages"
...
func (cfg Config) Initialize(ctx context.Context) (tools.Tool, error) {
	...
	params := parameters.Parameters{conversationIdParameter}
...
func (t Tool) Invoke(ctx context.Context, s sources.Source, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	resp, err := sdk.AllConversationMessages(conversationId, "", source.LookerApiSettings())
	if err != nil {
