...
package bigtableupdatematerializedview
...
const resourceType string = "bigtable-update-materialized-view"
...
type compatibleSource interface {
	UpdateMaterializedView(context.Context, string, string, string) (any, error)
}
...
func (cfg Config) Initialize(context.Context) (tools.Tool, error) {
	if cfg.Description == "" {
		cfg.Description = "Update an existing Bigtable materialized view."
	}
	...
	allParameters := parameters.Parameters{
		...
		parameters.NewStringParameter("query", "The updated materialized view query"),
	}
