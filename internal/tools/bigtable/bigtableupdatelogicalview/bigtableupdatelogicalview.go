...
package bigtableupdatelogicalview
...
const resourceType string = "bigtable-update-logical-view"
...
type compatibleSource interface {
	UpdateLogicalView(context.Context, string, string, string) (any, error)
}
...
func (cfg Config) Initialize(context.Context) (tools.Tool, error) {
	if cfg.Description == "" {
		cfg.Description = "Update an existing Bigtable logical view."
	}
	...
	allParameters := parameters.Parameters{
		...
		parameters.NewStringParameter("query", "The new logical view query"),
	}
