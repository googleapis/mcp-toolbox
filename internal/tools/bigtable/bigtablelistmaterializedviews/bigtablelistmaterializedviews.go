...
package bigtablelistmaterializedviews
...
const resourceType string = "bigtable-list-materialized-views"
...
func (cfg Config) Initialize(context.Context) (tools.Tool, error) {
	if cfg.Description == "" {
		cfg.Description = "List all existing Bigtable materialized views."
	}
