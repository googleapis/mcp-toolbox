...
const resourceType string = "bigtable-get-instance"
...
type compatibleSource interface {
	GetInstance(context.Context, string) (any, error)
}
...
func (cfg Config) Initialize(context.Context) (tools.Tool, error) {
	if cfg.Description == "" {
		cfg.Description = "Get details of a Bigtable instance."
	}

	allParameters := parameters.Parameters{
		parameters.NewStringParameter("instance_id", "The ID of the instance to get"),
	}
