...
type compatibleSource interface {
	CreateCluster(context.Context, string, string, string, int32) (any, error)
}
...
func (cfg Config) Initialize(context.Context) (tools.Tool, error) {
	...
	allParameters := parameters.Parameters{
		...
		parameters.NewIntParameter("num_nodes", "The number of nodes to allocate"),
	}
...
func (t Tool) Invoke(ctx context.Context, src sources.Source, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	res, err := source.CreateCluster(ctx, paramsMap["instance_id"].(string), paramsMap["cluster_id"].(string), paramsMap["zone"].(string), int32(paramsMap["num_nodes"].(int)))
	if err != nil {
