...
import (
	...
	"github.com/googleapis/mcp-toolbox/internal/tools/bigtable/bigtablelistlogicalviews"
...
func TestParseFromYamlBigtable(t *testing.T) {
	...
	tcs := []struct {
	...
	}{
		{
			...
			`,
			want: server.ToolConfigs{
				"example_tool": bigtablelistlogicalviews.Config{
...
func (m *mockSource) ListLogicalViews(ctx context.Context, instanceID string) (any, error) {
	...
	return []string{"view-1"}, nil
}

func TestInvoke(t *testing.T) {
	cfg := bigtablelistlogicalviews.Config{
