...
package bigtablegetlogicalview
...
const resourceType string = "bigtable-get-logical-view"
...
type compatibleSource interface {
	GetLogicalView(context.Context, string, string) (any, error)
}
...
func (cfg Config) Initialize(context.Context) (tools.Tool, error) {
	if cfg.Description == "" {
		cfg.Description = "Get details of a Bigtable logical view."
	}
