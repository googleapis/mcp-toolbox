...
func (r Config) Initialize(ctx context.Context, tracer trace.Tracer, deferConnect bool) (sources.Source, error) {
	...
	s := &Source{
		Config: r,
		tracer: tracer,
		conn:   sources.NewConnectOnce[*spanner.Client](ctx, r.Name, SourceType, r, tracer),
...
func (s *Source) client(ctx context.Context) (*spanner.Client, error) {
	return s.conn.DoWithConfig(ctx, func(ctx context.Context, sc sources.SourceConfig) (*spanner.Client, error) {
		r := sc.(Config)
