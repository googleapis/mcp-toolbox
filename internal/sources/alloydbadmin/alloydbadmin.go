...
func (r Config) Initialize(ctx context.Context, tracer trace.Tracer, deferConnect bool) (sources.Source, error) {
	s := &Source{
		...
		tracer:  tracer,
		conn:    sources.NewConnectOnce[*alloydbrestapi.Service](ctx, r.Name, SourceType, r, tracer),
	}
	if deferConnect {
		return s, nil
	}
...
func (s *Source) adminService(ctx context.Context) (*alloydbrestapi.Service, error) {
	return s.conn.DoWithConfig(ctx, func(ctx context.Context, sc sources.SourceConfig) (*alloydbrestapi.Service, error) {
		r := sc.(Config)
