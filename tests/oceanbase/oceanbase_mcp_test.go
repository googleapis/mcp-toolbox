...
func TestOceanBaseMCPListTools(t *testing.T) {
	setupOceanBaseTest(t)
...
func TestOceanBaseMCPCallTools(t *testing.T) {
	tableName := setupOceanBaseTest(t)
	runOceanBaseCallTests(t, tableName, []tests.InvokeTestOption{tests.WithMCP()},
